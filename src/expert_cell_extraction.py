...
for image_path in slides_list:
        ...
        '''if not(os.path.exists(os.path.join(save_path,'out_cells_results.pkl'))):
                ...
                in_cells_results = cellsegmentation(slide,in_sampled_patchs,patch_size_p,norm_dict,verbose=True,verbose_path=visual_path)

                out_sampled_patchs = sample_patchs(tumor_dict_2,out_mask,1)
                out_cells_results = cellsegmentation(slide,out_sampled_patchs,patch_size_p,norm_dict,verbose=True,verbose_path=visual_path)
